...
class Lexer(object):
    ...
    def __init__(self, rules, skip_whitespace=True):
        ...
        rules -- A list of rules
                Each entry is a rule which is a pair (`type`, `regex`).
                `type` is the type of the token. It must be unique.
                `regex` is the regular expression used to recognize the
                token.
    ...
    def symbols(self):
        ...
        return list(self.group_type.values())
